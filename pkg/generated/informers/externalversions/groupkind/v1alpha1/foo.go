...
import (
	...
	versioned "controller-crd/pkg/generated/clientset/versioned"
	internalinterfaces "controller-crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "controller-crd/pkg/generated/listers/groupkind/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GroupkindV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GroupkindV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&groupkindv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&groupkindv1alpha1.Foo{}, f.defaultInformer)
}
